...
public class BookTest {
    ...
    public void testBookConstructor() {
        ...
        // when
        // then
        assertEquals(java.util.Optional.of(121L), java.util.Optional.ofNullable(book1.getIdBook()));
        assertEquals(java.util.Optional.of(122L), java.util.Optional.ofNullable(book2.getIdBook()));
        assertEquals(java.util.Optional.of(123L), java.util.Optional.ofNullable(book3.getIdBook()));
    }
